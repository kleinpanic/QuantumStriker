...
- **Notes:**  
  - This version served as the proof-of-concept for the game’s core mechanics using a text-based interface.
...
- **Notes:**  
  - Enhanced the “feel” of the ship’s movement, making it more realistic and responsive.

---

## [0.0.5] - Bullet Origin & Trajectory Fixes
- **Bullet Origin:**  
  - Corrected the bullet spawn point calculation to match the ship’s tip.
  - Ensured that the bullet trajectory is computed with the same angle transformation as the player’s movement.
- **Code Adjustments:**  
  - Modified both `get_ship_tip` in player.c and `shoot_bullet` in bullet.c to subtract 90° (aligning 0° as up).
- **Notes:**  
  - Bullets now spawn and travel in the intended direction relative to the ship’s tip.
...
- **Dynamic Badge Generation:**  
  - Generated dynamic Shields.io badges for the top three scores (with trophy icons 🥇, 🥈, and 🥉).
